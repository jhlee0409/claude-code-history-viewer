...
const CHIPS: ReadonlyArray<{
  ...
  { mode: "content", labelKey: "recentEdits.viewContent", fallback: "Content" },
  { mode: "added", labelKey: "recentEdits.showAddedLines", fallback: "Added" },
  {
    mode: "removed",
    labelKey: "recentEdits.showRemovedLines",
    fallback: "Removed",
  },
  { mode: "diff", labelKey: "recentEdits.diff", fallback: "Diff" },
];
        ...
        {CHIPS.map((chip) => {
          ...
          return (
            <button
              ...
              aria-pressed={active}
              className={cn(
                "flex items-center gap-1 rounded px-1.5 py-0.5 text-px11 transition-all",
                active
