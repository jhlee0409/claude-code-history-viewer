 ...
 * 생성 시간: 2026-05-25T08:11:19.779Z
 * 총 키 개수: 1969
 * Namespace 수: 14
 */
...
/**
 * archive namespace의 번역 키 (115개)
 * 파일: locales/{lang}/archive.json
 */
export type ArchiveKeys =
  | 'archive.browse.card.created'
  | 'archive.browse.card.delete'
  | 'archive.browse.card.rename'
  | 'archive.browse.card.sessions'
  | 'archive.browse.card.source'
  | 'archive.browse.card.viewSessions'
  | 'archive.browse.delete.cancel'
  | 'archive.browse.delete.confirm'
  | 'archive.browse.delete.description'
  | 'archive.browse.delete.success'
  | 'archive.browse.delete.title'
  | 'archive.browse.empty.cta'
  | 'archive.browse.empty.description'
  | 'archive.browse.empty.title'
  | 'archive.browse.openFolder'
  | 'archive.browse.openFolderFailed'
  | 'archive.browse.rename.cancel'
  | 'archive.browse.rename.confirm'
  | 'archive.browse.rename.label'
  | 'archive.browse.rename.success'
  | 'archive.browse.rename.title'
  | 'archive.browse.sessions.back'
  | 'archive.browse.sessions.empty'
  | 'archive.browse.sessions.export'
  | 'archive.browse.sessions.messages'
  | 'archive.browse.sessions.subagents'
  | 'archive.browse.sessions.title'
  | 'archive.browse.sessions.viewMessages'
  | 'archive.browse.title'
  | 'archive.create.autoName'
  | 'archive.create.back'
  | 'archive.create.creating'
  | 'archive.create.description'
  | 'archive.create.descriptionPlaceholder'
  | 'archive.create.deselectAll'
  | 'archive.create.expiringBatchName'
  | 'archive.create.includeSubagents'
  | 'archive.create.includeSubagentsDescription'
  | 'archive.create.loadSessionsFailed'
  | 'archive.create.mainSessions'
  | 'archive.create.name'
  | 'archive.create.namePlaceholder'
  | 'archive.create.nameRequired'
  | 'archive.create.noProjectsFound'
  | 'archive.create.noSessions'
  | 'archive.create.noSessionsDescription'
  | 'archive.create.projectSearch'
  | 'archive.create.selectAll'
  | 'archive.create.sessionCount'
  | 'archive.create.sessions'
  | 'archive.create.sessionsRequired'
  | 'archive.create.sessionsSelected'
  | 'archive.create.step.selectProject'
  | 'archive.create.step.selectSessions'
  | 'archive.create.subagentSessions'
  | 'archive.create.submit'
  | 'archive.create.success'
  | 'archive.create.title'
  | 'archive.create.unsupportedProvider'
  | 'archive.description'
  | 'archive.error.createFailed'
  | 'archive.error.deleteFailed'
  | 'archive.error.exportFailed'
  | 'archive.error.loadExpiringFailed'
  | 'archive.error.loadFailed'
  | 'archive.error.loadSessionsFailed'
  | 'archive.error.renameFailed'
  | 'archive.export.success'
  | 'archive.overview.cleanupWarning.configured'
  | 'archive.overview.cleanupWarning.description'
  | 'archive.overview.cleanupWarning.notConfigured'
  | 'archive.overview.cleanupWarning.settingsLink'
  | 'archive.overview.cleanupWarning.title'
  | 'archive.overview.diskUsage.loadFailed'
  | 'archive.overview.diskUsage.sourceSize'
  | 'archive.overview.diskUsage.title'
  | 'archive.overview.diskUsage.totalArchives'
  | 'archive.overview.diskUsage.totalSessions'
  | 'archive.overview.diskUsage.totalSize'
  | 'archive.overview.expiring.archiveAll'
  | 'archive.overview.expiring.archiveAllMain'
  | 'archive.overview.expiring.archiveAllWithSubagents'
  | 'archive.overview.expiring.archiveButton'
  | 'archive.overview.expiring.archiveMainOnly'
  | 'archive.overview.expiring.archiveWithSubagents'
  | 'archive.overview.expiring.daysRemaining'
  | 'archive.overview.expiring.description'
  | 'archive.overview.expiring.mainSessions'
  | 'archive.overview.expiring.noExpiring'
  | 'archive.overview.expiring.noExpiringDescription'
  | 'archive.overview.expiring.noMainExpiring'
  | 'archive.overview.expiring.noSubagentExpiring'
  | 'archive.overview.expiring.projectSelect'
  | 'archive.overview.expiring.selectProject'
  | 'archive.overview.expiring.subagentSessions'
  | 'archive.overview.expiring.thresholdLabel'
  | 'archive.overview.expiring.title'
  | 'archive.overview.expiring.unsupportedProvider'
  | 'archive.overview.settings.cancel'
  | 'archive.overview.settings.cleanupDays'
  | 'archive.overview.settings.days'
  | 'archive.overview.settings.description'
  | 'archive.overview.settings.save'
  | 'archive.overview.settings.saveFailed'
  | 'archive.overview.settings.saved'
  | 'archive.overview.settings.thresholdDays'
  | 'archive.overview.settings.thresholdExceedsCleanup'
  | 'archive.overview.settings.title'
  | 'archive.overview.settings.toggle'
  | 'archive.overview.settings.unsavedChanges'
  | 'archive.settings.link'
  | 'archive.settings.linkDescription'
  | 'archive.tab.browse'
  | 'archive.tab.overview'
  | 'archive.title';

/**
 * antigravity namespace의 번역 키 (25개)
 * 파일: locales/{lang}/antigravity.json
 */
export type AntigravityKeys =
  | 'antigravity.activeSessions'
  | 'antigravity.archivedSessions'
  | 'antigravity.cacheReadTokens'
  | 'antigravity.cacheWriteTokens'
  | 'antigravity.error.loadFailed'
  | 'antigravity.inputTokens'
  | 'antigravity.loading'
  | 'antigravity.noData'
  | 'antigravity.noDataHint'
  | 'antigravity.outputTokens'
  | 'antigravity.reasoningTokens'
  | 'antigravity.refresh'
  | 'antigravity.session.active'
  | 'antigravity.session.archived'
  | 'antigravity.session.label'
  | 'antigravity.session.lastSeen'
  | 'antigravity.session.lifecycle'
  | 'antigravity.session.snapshots'
  | 'antigravity.session.totalTokens'
  | 'antigravity.snapshotHistory'
  | 'antigravity.subtitle'
  | 'antigravity.title'
  | 'antigravity.tokenBreakdown'
  | 'antigravity.totalSnapshots'
...
export type RemoteSourcesKeys =
  ...
  | 'remoteSources.confirmDelete'
  | 'remoteSources.description'
  | 'remoteSources.disabled'
  | 'remoteSources.editHost'
  | 'remoteSources.empty'
  | 'remoteSources.enabled'
  | 'remoteSources.error.hostUserRequired'
  | 'remoteSources.error.keyPathRequired'
  ...
  | 'remoteSources.missing.notFound'
  | 'remoteSources.missingTitle'
  | 'remoteSources.openManager'
  | 'remoteSources.opencodePaths'
  | 'remoteSources.passphrase'
  | 'remoteSources.password'
  ...
  | 'remoteSources.syncAllAllFailed'
