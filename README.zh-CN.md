...
浏览、搜索和分析 **Claude Code**、**Gemini CLI**、**Antigravity**、**Codex CLI**、**Cline**、**Cursor**、**Aider** 和 **OpenCode** 的对话记录 — 桌面应用或无头服务器。100% 离线。
...
**八个助手。一个查看器。** 在 Claude Code、Gemini CLI、Antigravity、Codex CLI、Cline、Cursor、Aider 和 OpenCode 会话之间无缝切换 — 比较 Token 用量、跨提供商搜索、在一个界面中分析你的工作流。
...
| 功能 | 描述 |
|---------|-------------|
| **多提供商支持** | 统一查看 **Claude Code**、**Gemini CLI**、**Antigravity**、**Codex CLI**、**Cline**、**Cursor**、**Aider** 和 **OpenCode** 对话 — 按提供商筛选、跨工具比较 |
...
| 功能 | 描述 |
|---------|-------------|
| **月历热力图** | 活动热力图拆分为月历块，按天可视化更加清晰 |
| **会话管理** | 删除会话（移至回收站）及在文件管理器中显示 JSONL 文件 |
| **复制路径** | 从项目右键菜单复制项目路径 |
| **统计日期筛选** | 分析仪表板支持按日期范围筛选 |
| **Windows 便携版** | 便携 `.zip` 构建 — 无需安装即可运行 |
| **工具专属卡片** | Bash、Read、Edit、Glob、Grep、Write、WebFetch、WebSearch、Agent 工具专用渲染卡片 |
