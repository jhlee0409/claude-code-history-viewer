...
瀏覽、搜尋和分析 **Claude Code**、**Codex CLI** 和 **OpenCode** 的對話記錄 — 桌面應用程式或無頭伺服器。100% 離線。
...
**三個助手。一個檢視器。** 在 Claude Code、Codex CLI 和 OpenCode 工作階段之間無縫切換 — 比較 Token 用量、跨提供者搜尋、在一個介面中分析您的工作流程。
...
| 功能 | 說明 |
|---------|-------------|
| **多提供者支援** | 統一檢視 **Claude Code**、**Codex CLI** 和 **OpenCode** 對話記錄 — 依提供者篩選、跨工具比較 |
